...
EMAIL_HOST_USER = os.environ.get("davidthomasinimforn001@gmail.com")
EMAIL_HOST_PASSWORD = os.environ.get("azwk lwmc wsms vrpi")

CONTACT_RECEIVE_EMAIL = os.environ.get(
